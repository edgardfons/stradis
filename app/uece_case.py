...
def turmas():
    ...
    Turma(codigo='1515', aulas_num=3, disciplina_id=1, professor_id=1, etapa=1, configs=turmas_block()).save()
    ...
    Turma(codigo='1523', aulas_num=2, disciplina_id=9, professor_id=6, etapa=2, configs=turmas_block()).save()
    Turma(codigo='1524', aulas_num=2, disciplina_id=10, professor_id=22, etapa=2, configs=turmas_block()).save()
    Turma(codigo='1525', aulas_num=2, disciplina_id=11, professor_id=21, etapa=2, configs=turmas_block()).save()
    Turma(codigo='1526', aulas_num=2, disciplina_id=12, professor_id=10, etapa=2, configs=turmas_block()).save()
    Turma(codigo='1527', aulas_num=2, disciplina_id=13, professor_id=16, etapa=3, configs=turmas_block()).save()
    Turma(codigo='1528', aulas_num=2, disciplina_id=14, professor_id=9, etapa=3, configs=turmas_block()).save()
    Turma(codigo='1529', aulas_num=2, disciplina_id=15, professor_id=20, etapa=3, configs=turmas_block()).save()
    Turma(codigo='1530', aulas_num=2, disciplina_id=16, professor_id=8, etapa=3, configs=turmas_block()).save()
    Turma(codigo='1531', aulas_num=2, disciplina_id=17, professor_id=12, etapa=3, configs=turmas_block()).save()
    Turma(codigo='1532', aulas_num=2, disciplina_id=18, professor_id=5, etapa=3, configs=turmas_block()).save()
    Turma(codigo='1533', aulas_num=2, disciplina_id=19, professor_id=13, etapa=4, configs=turmas_block()).save()
    Turma(codigo='1534', aulas_num=2, disciplina_id=20, professor_id=9, etapa=4, configs=turmas_block()).save()
    Turma(codigo='1535', aulas_num=2, disciplina_id=21, professor_id=17, etapa=4, configs=turmas_block()).save()
    Turma(codigo='1536', aulas_num=2, disciplina_id=22, professor_id=8, etapa=4, configs=turmas_block()).save()
    Turma(codigo='1537', aulas_num=2, disciplina_id=23, professor_id=17, etapa=4, configs=turmas_block()).save()
    Turma(codigo='1538', aulas_num=2, disciplina_id=24, professor_id=13, etapa=4, configs=turmas_block()).save()
    Turma(codigo='1539', aulas_num=2, disciplina_id=25, professor_id=4, etapa=5, configs=turmas_block()).save()
    Turma(codigo='1540', aulas_num=2, disciplina_id=26, professor_id=11, etapa=5, configs=turmas_block()).save()
    Turma(codigo='1541', aulas_num=2, disciplina_id=27, professor_id=16, etapa=5, configs=turmas_block()).save()
    Turma(codigo='1542', aulas_num=2, disciplina_id=28, professor_id=14, etapa=5, configs=turmas_block()).save()
    Turma(codigo='1543', aulas_num=2, disciplina_id=29, professor_id=7, etapa=5, configs=turmas_block()).save()
    Turma(codigo='1544', aulas_num=2, disciplina_id=30, professor_id=15, etapa=5, configs=turmas_block()).save()
    Turma(codigo='1545', aulas_num=2, disciplina_id=31, professor_id=4, etapa=6, configs=turmas_block()).save()
    Turma(codigo='1546', aulas_num=2, disciplina_id=32, professor_id=22, etapa=6, configs=turmas_block()).save()
    Turma(codigo='1547', aulas_num=2, disciplina_id=33, professor_id=6, etapa=6, configs=turmas_block()).save()
    Turma(codigo='1548', aulas_num=2, disciplina_id=34, professor_id=12, etapa=6, configs=turmas_block()).save()
    Turma(codigo='1549', aulas_num=2, disciplina_id=35, professor_id=10, etapa=6, configs=turmas_block()).save()
    Turma(codigo='1550', aulas_num=2, disciplina_id=36, professor_id=1, etapa=6, configs=turmas_block()).save()
    Turma(codigo='1551', aulas_num=2, disciplina_id=37, professor_id=16, etapa=7, configs=turmas_block()).save()
    Turma(codigo='1552', aulas_num=2, disciplina_id=38, professor_id=14, etapa=7, configs=turmas_block()).save()
    Turma(codigo='1553', aulas_num=2, disciplina_id=39, professor_id=3, etapa=8, configs=turmas_block()).save()
